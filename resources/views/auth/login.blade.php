...
@php
    $pageTitle = 'Login';
    $pageDescription = 'Sign in to manage your posts and account.';
@endphp
        ...
        <div>
            <div class="mx-auto h-12 w-12 flex items-center justify-center rounded-full bg-indigo-100">
                <svg class="h-6 w-6 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 10v-2a3 3 0 00-3-3H6a3 3 0 00-3 3v2m6-8a3 3 0 11-6 0 3 3 0 016 0z"></path>
                </svg>
            </div>
